...
custom_replacements = {
  ...
  */
  names = {
    ...
    management_resource_group_name               = "rgbdo5-management-$${starter_location_01}"
    connectivity_hub_vwan_resource_group_name    = "rgbdo5-hub-vwan-$${starter_location_01}"
    connectivity_hub_primary_resource_group_name = "rgbdo5-hub1-$${starter_location_01}"
    connectivity_hub_secondary_resource_group_name = "rgbdo5-hub2-$${starter_location_02}"    
    dns_resource_group_name                      = "rgbdo5-hub-dns-$${starter_location_01}"
    # ddos_resource_group_name                     = "rgbdo5-hub-ddos-$${starter_location_01}"
    asc_export_resource_group_name               = "rgbdo5-asc-export-$${starter_location_01}"

    # Resource names
    log_analytics_workspace_name            = "bdo5law-management-$${starter_location_01}"
    # ddos_protection_plan_name               = "bdo5ddos-$${starter_location_01}"
    automation_account_name                 = "bdo5aa-management-$${starter_location_01}"
    ama_user_assigned_managed_identity_name = "bdo5uami-management-ama-$${starter_location_01}"
    dcr_change_tracking_name                = "bdo5dcr-change-tracking"
    dcr_defender_sql_name                   = "bdo5dcr-defender-sql"
    dcr_vm_insights_name                    = "bdo5dcr-vm-insights"

    # Resource names primary connectivity
    primary_hub_name                                   = "bdo5vwan-hub1-$${starter_location_01}"
    primary_sidecar_virtual_network_name               = "bdo5vnet-sidecar1-$${starter_location_01}"
    primary_firewall_name                              = "bdo5fw-hub1-$${starter_location_01}"
    primary_firewall_policy_name                       = "bdo5fwp-hub1-$${starter_location_01}"
    primary_virtual_network_gateway_express_route_name = "bdo5vgw-hub1-er-$${starter_location_01}"
    primary_virtual_network_gateway_vpn_name           = "bdo5vgw-hub1-vpn-$${starter_location_01}"
    primary_private_dns_resolver_name                  = "bdo5pdr-hub1-dns-$${starter_location_01}"
    # primary_bastion_host_name                          = "bdo5bas-hub-$${starter_location_01}"
    # primary_bastion_host_public_ip_name                = "bdo5pip-bastion-hub-$${starter_location_01}"

    # Resource names primary secondary
    secondary_hub_name                                   = "bdo5vwan-hub2-$${starter_location_02}"
    secondary_sidecar_virtual_network_name               = "bdo5vnet-sidecar2-$${starter_location_02}"
    secondary_firewall_name                              = "bdo5fw-hub2-$${starter_location_02}"
    secondary_firewall_policy_name                       = "bdo5fwp-hub2-$${starter_location_02}"
    secondary_virtual_network_gateway_express_route_name = "bdo5vgw-hub2-er-$${starter_location_02}"
    secondary_virtual_network_gateway_vpn_name           = "bdo5vgw-hub2-vpn-$${starter_location_02}"
    secondary_private_dns_resolver_name                  = "bdo5pdr-hub2-dns-$${starter_location_02}"
...
tags = {
  ...
  source      = "bdo5 Azure Landing Zones Accelerator"
}
